            ...
            <div className="flex gap-3 overflow-x-auto no-scrollbar -mx-4 px-4">
              {categories.map(c => (
                <button key={c.id} onClick={() => setActive(c.label)}
                  className={`min-w-[140px] flex-shrink-0 flex items-center gap-3 p-3 rounded-lg transition-all duration-200 border ${active === c.label ? 'bg-orange-50 border-orange-300 shadow-sm' : 'bg-white border-border'}`}>
